...
/*
 download url: http://www.unix-ag.uni-kl.de/~massar/soft/cisco-decrypt.c
 homepage: http://www.unix-ag.uni-kl.de/~massar/bin/cisco-decode
 On a debian based system, you need to install gcc and libgcrypt11-dev:
apt-get install gcc libgcrypt11-dev
 */
/*
